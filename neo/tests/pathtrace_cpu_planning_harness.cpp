...
void TestStaticBucketAssignmentPlan()
{
    ...
    Check(
        IsSmokeStaticBucketCleanDiSecondaryIsolationSupported(
            ...
            false,
            7),
        "static bucket view-16 isolation admits stage seven for spatial DispatchRays only");
    Check(
        IsSmokeStaticBucketCleanDiSecondaryIsolationSupported(
            RT_SMOKE_STATIC_BUCKET_ROUTE_PRIMARY_OPAQUE_PROBE,
            true,
    ...
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        spatialDispatchOnlyPlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                ...
                7);
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        materialFeaturePipelineOnlyPlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                true,
                true,
                true,
    ...
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        transmissionAnyHitBoundedPlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                ...
                15);
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        transmissionAnyHitIgnoreOncePlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                true,
                true,
                true,
    ...
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        transmissionInitialOnlyControlPlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                ...
                19);
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        transmissionTemporalControlPlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                true,
                true,
                true,
    ...
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        transmissionInitialPresentedControlPlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                ...
                21);
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        transmissionTupleDiagnosticPlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                true,
                true,
                true,
                ...
                22);
    const RtSmokeStaticBucketSecondaryIsolationDispatchPlan
        transmissionClosestHitPositionDiagnosticPlan =
            BuildSmokeStaticBucketSecondaryIsolationDispatchPlan(
                true,
                true,
                true,
    ...
    Check(
        primaryPipelineOnlyPlan.active &&
            ...
            !primaryPipelineOnlyPlan.materialFeaturePipelineCreation &&
            ...
            !primaryDispatchOnlyPlan.materialFeaturePipelineCreation &&
            ...
            !cleanDiPipelineOnlyPlan.materialFeaturePipelineCreation &&
            !cleanDiPipelineOnlyPlan.materialFeatureCompose &&
            initialDiOnlyPlan.active &&
            initialDiOnlyPlan.stage == 4 &&
            initialDiOnlyPlan.primaryPipelineCreation &&
            initialDiOnlyPlan.primaryDispatch &&
            ...
            !initialDiOnlyPlan.materialFeaturePipelineCreation &&
            ...
            !temporalDiOnlyPlan.materialFeaturePipelineCreation &&
            ...
            !spatialPipelineOnlyPlan.materialFeaturePipelineCreation &&
            !spatialPipelineOnlyPlan.materialFeatureCompose &&
            spatialDispatchOnlyPlan.active &&
            spatialDispatchOnlyPlan.stage == 7 &&
            spatialDispatchOnlyPlan.primaryPipelineCreation &&
            spatialDispatchOnlyPlan.primaryDispatch &&
            spatialDispatchOnlyPlan.cleanDiPipelineCreation &&
            spatialDispatchOnlyPlan.initial &&
            spatialDispatchOnlyPlan.temporal &&
            spatialDispatchOnlyPlan.spatialPipelineCreation &&
            spatialDispatchOnlyPlan.spatial &&
            !spatialDispatchOnlyPlan.transmissionPsr &&
            !spatialDispatchOnlyPlan.materialFeaturePipelineCreation &&
            !spatialDispatchOnlyPlan.materialFeatureCompose &&
            materialFeaturePipelineOnlyPlan.active &&
            materialFeaturePipelineOnlyPlan.stage == 8 &&
            materialFeaturePipelineOnlyPlan.primaryPipelineCreation &&
            materialFeaturePipelineOnlyPlan.primaryDispatch &&
            materialFeaturePipelineOnlyPlan.cleanDiPipelineCreation &&
            materialFeaturePipelineOnlyPlan.initial &&
            materialFeaturePipelineOnlyPlan.temporal &&
    ...
    Check(
        transmissionTraversalNoHitShadersPlan.active &&
            ...
            transmissionAnyHitIgnoreOncePlan.active &&
            ...
            transmissionTemporalControlPlan.active &&
            transmissionTemporalControlPlan.stage == 20 &&
            transmissionTemporalControlPlan.primaryPipelineCreation &&
            transmissionTemporalControlPlan.primaryDispatch &&
            transmissionTemporalControlPlan.cleanDiPipelineCreation &&
            transmissionTemporalControlPlan.materialFeaturePipelineCreation &&
            transmissionTemporalControlPlan.materialFeatureRuntimeBindings &&
            transmissionTemporalControlPlan.transmissionPsr &&
            transmissionTemporalControlPlan.transmissionTraceProbeMode == 0 &&
            transmissionTemporalControlPlan.transmissionIterativeResolve &&
            !transmissionTemporalControlPlan.transmissionMonolithicControl &&
            transmissionTemporalControlPlan.initial &&
            ...
            !transmissionInitialPresentedControlPlan.transmissionTupleDiagnostic &&
            transmissionTupleDiagnosticPlan.active &&
            transmissionTupleDiagnosticPlan.stage == 22 &&
            transmissionTupleDiagnosticPlan.primaryPipelineCreation &&
            transmissionTupleDiagnosticPlan.primaryDispatch &&
            transmissionTupleDiagnosticPlan.cleanDiPipelineCreation &&
            transmissionTupleDiagnosticPlan.materialFeaturePipelineCreation &&
            transmissionTupleDiagnosticPlan.materialFeatureRuntimeBindings &&
            transmissionTupleDiagnosticPlan.transmissionPsr &&
            transmissionTupleDiagnosticPlan.transmissionTraceProbeMode == 7 &&
            transmissionTupleDiagnosticPlan.transmissionIterativeResolve &&
            !transmissionTupleDiagnosticPlan.transmissionMonolithicControl &&
            transmissionTupleDiagnosticPlan.transmissionTupleDiagnostic &&
            !transmissionTupleDiagnosticPlan.
                transmissionClosestHitPositionDiagnostic &&
            transmissionTupleDiagnosticPlan.initial &&
            !transmissionTupleDiagnosticPlan.temporal &&
            !transmissionTupleDiagnosticPlan.spatialPipelineCreation &&
            !transmissionTupleDiagnosticPlan.spatial &&
            !transmissionInitialPresentedControlPlan.materialFeatureCompose &&
            !transmissionTupleDiagnosticPlan.materialFeatureCompose &&
            transmissionClosestHitPositionDiagnosticPlan.active &&
            transmissionClosestHitPositionDiagnosticPlan.stage == 23 &&
            transmissionClosestHitPositionDiagnosticPlan.primaryPipelineCreation &&
            transmissionClosestHitPositionDiagnosticPlan.primaryDispatch &&
            transmissionClosestHitPositionDiagnosticPlan.cleanDiPipelineCreation &&
            transmissionClosestHitPositionDiagnosticPlan.materialFeaturePipelineCreation &&
            transmissionClosestHitPositionDiagnosticPlan.materialFeatureRuntimeBindings &&
            transmissionClosestHitPositionDiagnosticPlan.transmissionPsr &&
            transmissionClosestHitPositionDiagnosticPlan.transmissionTraceProbeMode == 6 &&
            transmissionClosestHitPositionDiagnosticPlan.transmissionIterativeResolve &&
            !transmissionClosestHitPositionDiagnosticPlan.transmissionMonolithicControl &&
            !transmissionClosestHitPositionDiagnosticPlan.transmissionTupleDiagnostic &&
            transmissionClosestHitPositionDiagnosticPlan.
                transmissionClosestHitPositionDiagnostic &&
            transmissionClosestHitPositionDiagnosticPlan.initial &&
            !transmissionClosestHitPositionDiagnosticPlan.temporal &&
            !transmissionClosestHitPositionDiagnosticPlan.spatialPipelineCreation &&
    ...
    Check(
        IsSmokeStaticBucketProductionRouteSupported(
            ...
            !IsSmokeStaticBucketProductionRouteSupported(
                ...
                false,
                24),
        "static bucket route-1 production checkpoint admits bounded optics and clean GI separately, fails closed for their unstable refracted intersection, and keeps external PDF-NEE, RR, and later probe stages closed");
    Check(
    ...
    Check(
        waitingForPublicationPlan.active &&
            ...
            !waitingForPublicationPlan.materialFeaturePipelineCreation &&
            ...
            !unsupportedIsolationPlan.materialFeaturePipelineCreation,
