...
inline RtPathTraceMaterialFeatureBindingDesc PathTraceCleanRtxdiDiTransmissionSidecarBinding()
{
...
inline RtPathTraceMaterialFeatureBindingDesc PathTraceCleanRtxdiDiGlassDistortionSidecarBinding()
{
    return PathTraceCleanRtxdiDiCanonicalBinding(RT_MATERIAL_FEATURE_RESOURCE_GLASS_DISTORTION_SIDECAR);
}
...
inline uint32_t PathTraceCleanRtxdiDiGlassComposeInputResources()
{
    return
    ...
    size_t& bindingCount)
{
    static const RtPathTraceMaterialFeatureBindingDesc kComposedGlassBindings[] = {
        ...
        PathTraceCleanRtxdiDiGlassDistortionSidecarBinding(),
    ...
    float transmissionFloor)
{
    ...
    params.params1[RT_PATH_TRACE_OBJECT_GLASS_PARAM1_REFLECTION_BOOST] = reflectionBoost;
    params.params1[RT_PATH_TRACE_OBJECT_GLASS_PARAM1_TRANSMISSION_FLOOR] = transmissionFloor;
