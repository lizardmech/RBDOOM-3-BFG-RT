...
enum RtPathTraceMaterialFeatureResourceMask : uint32_t
{
    ...
    RT_MATERIAL_FEATURE_RESOURCE_RR_GUIDE_SPECULAR_ALBEDO = 1u << 17,
    RT_MATERIAL_FEATURE_RESOURCE_RR_INPUT_COLOR = 1u << 18,
    RT_MATERIAL_FEATURE_RESOURCE_TRANSMISSION_SIDECAR = 1u << 19,
    RT_MATERIAL_FEATURE_RESOURCE_REFLECTION_SIDECAR = 1u << 20,
    RT_MATERIAL_FEATURE_RESOURCE_REFLECTION_OUTPUT = 1u << 21,
    RT_MATERIAL_FEATURE_RESOURCE_GLASS_DISTORTION_OUTPUT = 1u << 22,
    RT_MATERIAL_FEATURE_RESOURCE_GLASS_DISTORTION_SIDECAR = 1u << 23
};
