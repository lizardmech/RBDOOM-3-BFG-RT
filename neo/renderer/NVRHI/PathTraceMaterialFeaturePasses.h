...
enum RtPathTraceMaterialFeatureResourceMask : uint32_t
{
    ...
    RT_MATERIAL_FEATURE_RESOURCE_GLASS_GUIDE_CANDIDATE0 = 1u << 19,
    RT_MATERIAL_FEATURE_RESOURCE_GLASS_GUIDE_CANDIDATE1 = 1u << 20,
    RT_MATERIAL_FEATURE_RESOURCE_GLASS_GUIDE_CANDIDATE2 = 1u << 21
};
