...
enum RtPathTracePrimarySurfaceDebugStatus : uint32_t
{
    ...
    RT_PRIMARY_SURFACE_DEBUG_MISSING_PREVIOUS_CAMERA = 13,
    RT_PRIMARY_SURFACE_DEBUG_PREVIOUS_BEHIND_CAMERA = 14,
    RT_PRIMARY_SURFACE_DEBUG_PREVIOUS_XY_OUTSIDE_FRAME = 15,
    RT_PRIMARY_SURFACE_DEBUG_STATIC_RANGE_MISMATCH = 16,
    RT_PRIMARY_SURFACE_DEBUG_STATIC_MATERIAL_CLASS_MISMATCH = 17,
    RT_PRIMARY_SURFACE_DEBUG_PACKED_OBJECT_MISSING_PREVIOUS_MOTION = 18,
    RT_PRIMARY_SURFACE_DEBUG_LIQUID_FILM_TRANSITION = 19,
    RT_PRIMARY_SURFACE_DEBUG_LIQUID_ALBEDO_MISMATCH = 20,
    RT_PRIMARY_SURFACE_DEBUG_LIQUID_F0_MISMATCH = 21,
    RT_PRIMARY_SURFACE_DEBUG_LIQUID_ROUGHNESS_MISMATCH = 22,
    RT_PRIMARY_SURFACE_DEBUG_LIQUID_NORMAL_MISMATCH = 23
};

enum RtPathTraceSurfaceFlags : uint32_t
{
    RT_PATH_TRACE_SURFACE_FLAG_LIQUID_FILM_NORMAL_APPLIED = 0x00100000u,
    RT_PATH_TRACE_SURFACE_FLAG_LIQUID_FILM_APPLIED = 0x10000000u
};
