...
struct PathTraceUnifiedPtDispatchInputs
{
    ...
    bool secondaryNeeOne = false;
    bool exactSecondaryMis = true;
    bool replayFreeSecondaryNee = false;
    bool geometryNoSkinned = false;
    bool splitContinuation = false;
    bool lambertDiagnostic = false;
    bool debugThinProduce = false;
    bool debugThinProduceRay = false;
    int produceBodyProbe = 0;
    bool tiledSurface = false;
    bool reservoirTexture = false;
    bool primaryTexture = false;
    bool onePathGeometry = false;
    bool neeCache = false;
    bool q1Sibling = false;
    bool lambertBsdf = false;
    nvrhi::IBuffer* neeCacheCellBuffer = nullptr;
    nvrhi::IBuffer* neeCacheCandidateBuffer = nullptr;
    nvrhi::IBuffer* neeCachePlaceholderBuffer = nullptr;
...
private:
    ...
    bool EnsureQ1SiblingBuffers(const PathTraceUnifiedPtDispatchInputs& inputs);
    void ReleaseX3Split();
    ...
    nvrhi::TextureHandle CurrentReservoirTex() const;
    nvrhi::TextureHandle HistoryReservoirTex() const;
    nvrhi::TextureHandle ResolveReservoirTex() const;
    bool EnsureReservoirTextures(const PathTraceUnifiedPtDispatchInputs& inputs);
    nvrhi::TextureHandle CurrentPrimaryTex() const;
    nvrhi::TextureHandle HistoryPrimaryTex() const;
    nvrhi::TextureHandle HistorySidecarTex() const;
    bool EnsurePrimaryTextures(const PathTraceUnifiedPtDispatchInputs& inputs);
    bool EnsurePrimaryImageCopyPipeline(const PathTraceUnifiedPtDispatchInputs& inputs);
    bool ExecutePrimaryImageCopy(const PathTraceUnifiedPtDispatchInputs& inputs);
    bool EnsureOnePathGeometry(const PathTraceUnifiedPtDispatchInputs& inputs);
    bool ExecuteOnePathGeometryPack(const PathTraceUnifiedPtDispatchInputs& inputs);
    ...
    bool m_secondaryNeeOne = false;
    bool m_exactSecondaryMis = true;
    bool m_replayFreeSecondaryNee = false;
    bool m_geometryNoSkinned = false;
    bool m_splitContinuation = false;
    bool m_lambertDiagnostic = false;
    bool m_debugThinProduce = false;
    bool m_tiledSurface = false;
    bool m_reservoirTexture = false;
    bool m_primaryTexture = false;
    bool m_onePathGeometry = false;
    bool m_neeCache = false;
    bool m_q1Sibling = false;
    bool m_lambertBsdf = false;
    bool m_debugThinProduceRay = false;
    int m_produceBodyProbe = 0;
    ...
    nvrhi::TextureHandle m_page0Tex;
    nvrhi::TextureHandle m_page1Tex;
    nvrhi::TextureHandle m_dummyReservoirTex;
    nvrhi::TextureHandle m_primaryCurrentTex;
    nvrhi::TextureHandle m_primaryPreviousTex;
    nvrhi::TextureHandle m_primarySidecarTex;
    nvrhi::TextureHandle m_dummyPrimaryTex;
    nvrhi::BindingLayoutHandle m_primaryCopyBindingLayout;
    nvrhi::ShaderHandle m_primaryCopyShader;
    nvrhi::ComputePipelineHandle m_primaryCopyPipeline;
    bool m_primaryCopyPipelineAttempted = false;
    std::array<nvrhi::BindingSetHandle, 3> m_primaryCopyBindingSets;
    std::array<nvrhi::BindingSetDesc, 3> m_primaryCopyBindingSetDescs;
    std::array<bool, 3> m_primaryCopyBindingSetDescValid = { false, false, false };
    ...
    nvrhi::ShaderHandle m_q1SiblingShader;
    nvrhi::ComputePipelineHandle m_q1SiblingPipeline;
    uint32_t m_q1Capacity = 0u;
    uint32_t m_q1TokenStride = 0u;
    nvrhi::BufferHandle m_q1Queue;
    nvrhi::BufferHandle m_q1Meta;
    nvrhi::BufferHandle m_q1DispatchArgs;
    ...
    nvrhi::BufferHandle m_onePathVertices;
    nvrhi::BufferHandle m_onePathIndices;
    nvrhi::BufferHandle m_onePathMaterials;
    nvrhi::BufferHandle m_onePathClasses;
    nvrhi::BufferHandle m_onePathInstances;
    nvrhi::BufferHandle m_onePathDummyUint;
    uint32_t m_onePathVertexBytes = 0;
    uint32_t m_onePathIndexBytes = 0;
    uint32_t m_onePathMaterialCount = 0;
    uint32_t m_onePathInstanceCount = 0;
    nvrhi::BindingLayoutHandle m_onePathPackBindingLayout;
    nvrhi::BindingSetHandle m_onePathPackBindingSet;
    nvrhi::BindingSetDesc m_onePathPackBindingSetDesc;
    bool m_onePathPackBindingSetDescValid = false;
    nvrhi::ShaderHandle m_onePathPackShader;
    nvrhi::ComputePipelineHandle m_onePathPackPipeline;
    bool m_onePathPackPipelineAttempted = false;
