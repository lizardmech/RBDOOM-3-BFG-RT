...
enum
{
	...
	BUILTIN_PT_SKY_CUBE_PROBE_CS,
	BUILTIN_PT_SKY_SURFACE_RESOLVE_CS,
	BUILTIN_NEE_CACHE_PRIMARY_SURFACE_UPDATE_CS,
	BUILTIN_PT_PARTICLE_LIGHTING_CS,
	BUILTIN_PT_PARTICLE_COMPOSITE,
	// SP End
