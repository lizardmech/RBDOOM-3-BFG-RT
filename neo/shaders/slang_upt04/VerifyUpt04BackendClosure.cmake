...
foreach(kind rayquery raygen)
    ...
    if(NOT descriptor_binding_count EQUAL 32)
        message(FATAL_ERROR "UPT-04 ${kind} must expose exactly 35 descriptor bindings")
    endif()
...
if(NOT diagnostic_binding_count EQUAL 33)
    message(FATAL_ERROR "UPT-04 diagnostic entry must expose exactly 33 descriptor bindings")
endif()
