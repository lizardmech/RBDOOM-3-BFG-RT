...
foreach(kind rayquery raygen)
    ...
    if(NOT descriptor_binding_count EQUAL 24)
        message(FATAL_ERROR "UPT-04 ${kind} must expose exactly 24 descriptor bindings")
    endif()
...
if(NOT diagnostic_binding_count EQUAL 25)
    message(FATAL_ERROR "UPT-04 diagnostic entry must expose exactly 25 descriptor bindings")
endif()
